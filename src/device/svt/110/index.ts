...
import { ACC3_ODR2, DEVICE_COMMAND } from "../../constants";
...
const ODR_OPTIONS = [
  { label: "odr.0.718KHz", value: 5 },
  { label: "odr.1.562KHz", value: 6 },
  { label: "odr.3.125KHz", value: 7 },
  { label: "odr.6.25KHz", value: 12 },
  { label: "odr.12.5KHz", value: 13 },
];
