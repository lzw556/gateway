...
const RANGE_OPTIONS = [
  { label: "range.8g", value: 0 },
  { label: "range.16g", value: 1 },
  { label: "range.32g", value: 2 },
  { label: "range.64g", value: 3 },
];

const ODR_OPTIONS = [
  { label: "odr.0.4KHz", value: 5 },
  { label: "odr.0.8KHz", value: 6 },
  { label: "odr.1.6KHz", value: 7 },
  { label: "odr.3.2KHz", value: 12 },
  { label: "odr.6.4KHz", value: 13 },
  { label: "odr.12.8KHz", value: 14 },
  { label: "odr.25.6KHz", value: 15 },
];

const DEN_IS_ENABLED: DeviceSensorSettingsField = {
  label: "sensor.settings.den.is.enabled",
  name: ["settings", "sensors", "den_is_enabled"],
  tag: "switch",
};
